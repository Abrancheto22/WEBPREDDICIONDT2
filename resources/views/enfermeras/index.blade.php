            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <input type="text" id="search-enfermeras" class="form-control form-control-sm" placeholder="Buscar..." />
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap" id="table-enfermeras">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>DNI</th>
...
document.addEventListener('DOMContentLoaded', function () {
  const input = document.getElementById('search-enfermeras');
  const table = document.getElementById('table-enfermeras');
