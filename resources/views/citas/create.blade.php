                        ...
                        <form action="{{ route('citas.store') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select
                                        ...
                                        @foreach($pacientes as $paciente)
                                            <option value="{{ $paciente->idpaciente }}" {{ old('paciente') == $paciente->idpaciente ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select
                                        ...
                                        @foreach($doctores as $doctor)
                                            <option value="{{ $doctor->iddoctor }}" {{ old('doctor') == $doctor->iddoctor ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select
                                        ...
                                        @foreach($enfermeras as $enfermera)
                                            <option value="{{ $enfermera->idenfermera }}" 
                                                {{ (old('enfermera') == $enfermera->idenfermera || $enfermera->idenfermera == $enfermera_id) ? 'selected' : '' }}>
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bx bx-save"></i> Guardar Cita
                                </button>
                            </div>
                        </form>
                    </div>
